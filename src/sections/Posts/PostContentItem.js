            ...
            <Link to={`/${type[typePost].path}/${normalizedTitle}.${post['id_'+typePost]}`}>
                <FeaturedPosttWrap>
                    <LazyLoad height={200} offset={100}>
                        <FeaturedPosttImage image={imageError ? '/assets/no_image.jpeg' :`${process.env.REACT_APP_HOST}/read_image/${post.image}`}>
                            <img
                                src={`${process.env.REACT_APP_HOST}/read_image/${post.image}`}
                                alt="Image replace"
